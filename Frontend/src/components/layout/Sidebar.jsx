        ...
        <div className="bg-[#121212] rounded-xl h-full flex flex-col py-4">
          ...
          {isAuthenticated && (
            ...
            >
              ...
              >
                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-green-400 to-blue-500 flex-shrink-0 flex items-center justify-center text-white font-bold text-lg hover:brightness-110 transition-all shadow-md">
